...
- [Items And Inventory Implementation Plan](ITEMS_INVENTORY_IMPLEMENTATION_PLAN.md)
  ...
  5 are complete, including the item catalog, Unity authoring, PostgreSQL schema,
  transactional catalog mirror, character item-state bootstrap, read-only
  catalog and inventory snapshots, and the internal race-safe transaction
  kernel. Phase 6 is next.

...
- [Items And Inventory Implementation Plan](ITEMS_INVENTORY_IMPLEMENTATION_PLAN.md)
  ...
  4 are complete, including the item catalog, Unity authoring, PostgreSQL schema,
  transactional catalog mirror, character item-state bootstrap, and read-only
  catalog and inventory snapshots. Phase 5 is next.

...
{
    public const string MeterName = "ShooterMmo.WorldServer.Realtime";
    ...
    {
        meter.CreateObservableGauge("worldserver.realtime.peers", () => Volatile.Read(ref activePeers));
        meter.CreateObservableGauge("worldserver.realtime.entities", () => Volatile.Read(ref activeEntities));
        meter.CreateObservableCounter("worldserver.realtime.received.packets", () => Volatile.Read(ref receivedPackets));
        meter.CreateObservableCounter("worldserver.realtime.received.bytes", () => Volatile.Read(ref receivedBytes));
        meter.CreateObservableCounter("worldserver.realtime.sent.packets", () => Volatile.Read(ref sentPackets));
        meter.CreateObservableCounter("worldserver.realtime.sent.bytes", () => Volatile.Read(ref sentBytes));
        meter.CreateObservableCounter("worldserver.realtime.quota_rejected.packets", () => Volatile.Read(ref quotaRejectedPackets));
        meter.CreateObservableCounter("worldserver.realtime.snapshot_dropped.packets", () => Volatile.Read(ref droppedSnapshotPackets));
        meter.CreateObservableCounter("worldserver.realtime.joins.accepted", () => Volatile.Read(ref acceptedJoins));
        meter.CreateObservableCounter("worldserver.realtime.joins.rejected", () => Volatile.Read(ref rejectedJoins));
        meter.CreateObservableCounter("worldserver.realtime.spawn.packets", () => Volatile.Read(ref spawnPackets));
        meter.CreateObservableCounter("worldserver.realtime.despawn.packets", () => Volatile.Read(ref despawnPackets));
        meter.CreateObservableCounter("worldserver.realtime.snapshot.entity_records", () => Volatile.Read(ref snapshotEntityRecords));
    }
